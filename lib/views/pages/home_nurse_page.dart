...
import 'package:home_health/views/widgets/data_loader.dart';
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: Obx(
                () => DataLoader(
                    hasNoData: nurseDataController.visits.isEmpty,
                                ...
                                children: [
                                  for (int i = 0;
                                    ...
                                    ScheduleTileDelegate(
                                      isLast: i ==
                                          nurseDataController.delegates.length -
                                              1,
                                      width: nurseDataController
                                                  .delegates.length ==
                                              1
